...
<head>
<meta charset="UTF-8">
<title>西科大BBS论坛-版主查看主题-欢迎来到西科大BBS论坛，这里有最新的校园咨询，最热的校园热点！</title>
	...
	<div class="mid">
		...
		<div class="mid2">
			...
			<div class="imgtop">
				...
				<!--这里要改要改成数据库的板块！！！！！！！！！！！！！！！！！！！！！！！！！！！1-->
				<span><%=forumList.get(0).getForumType()%>-最新主题</span>
			...
			<div class="tiezi">
				<table cellspacing="0" cellpadding="0" class="table">
					...
					<tr>
						...
						<td><a href="<%=request.getContextPath()%>/topforum.do?forumId=<%=forum.getForumId()%>&page=1&pagesize=10">
								<div>置顶</div>
						</a></td>
						<td><a href="<%=request.getContextPath()%>/deleteforum.do?forumId=<%=forum.getForumId()%>&page=1&pagesize=10">
								<div>删除</div>
						</a></td>
					</tr>
					<%
			...
			<div class="publish">
				<form action="modaddforum.do?type=<%=forumList.get(0).getForumType()%>&page=1&pagesize=10" method="post">
					<p>发表主题贴</p>
					<div>
						<span>标题</span> </br> <input name="forumTitle"
							style="width: 100%; height: 100%; font-size: 18px;" type="text" />
						</br> <span>内容</span> </br>
						<textarea name="forumContent"
							style="width: 100%; height: 150px; resize: none; font-size: 18px;"></textarea>
					</div>
